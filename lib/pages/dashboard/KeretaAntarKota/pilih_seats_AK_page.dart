...
class PilihSeatsAntarKotaPage extends StatefulWidget {
  const PilihSeatsAntarKotaPage({super.key});

  @override
  _PilihSeatsAntarKotaPageState createState() => _PilihSeatsAntarKotaPageState();
}

class _PilihSeatsAntarKotaPageState extends State<PilihSeatsAntarKotaPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text("Pilih Kursi Antar Kota")),
      body: isLoading
          ...
          child: Row(
            ...
            children: allCols.map((col) {
              if (col == 'C') {
                return Row(
                  children: [
                    const SizedBox(width: 24), // gap antara B dan C
